public class HW05_4108056018_3 extends LLK {
	// only look 0.05 percent,assume the answer always on the right side, last limit: 0.1 percent
	...
	public final boolean checkLLK(int[][] array) {
		...
		if (len >= 2000) 
		{
			final int segement = len / 2000;
			final int bound = segement*1999;
