public class HW09_4108056018_5 extends LSD 
{
	/*
	...
	*/
	public final static listNode adjListHead[] = new listNode[10000000];
	public final static listNode adjListTail[] = new listNode[10000000];
	public final static byte haveVisited[] = new byte[10000000];
	public final static int queue[] = new int[1000000];
	...
	public final int Distance(final int[][] inputArr)
	{
		...
		for(int k = 0; k < len; k++)//iterate the edge info,we choose 1 vertices of the edge to do BFS
		{
			final int i = inputArr[k][0];
			
			if(haveVisited[i] == 2)//visit complete
			{
				continue;
			}
